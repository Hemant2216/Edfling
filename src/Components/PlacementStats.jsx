...
const SubmitPlacement = () => {
  return (
    <div className='flex max-sm:flex-col items-center w-full justify-between bg-slate-green rounded-2xl mt-5 py-3 px-4' style={{marginLeft:"20px",width:"970px",height:"120px"}}>
      ...
      <div className='flex w-2/6 max-sm:w-full max-sm:justify-center justify-end'>
        <button className='bg-white text-slate-green font-semibold py-3 px-5 rounded-xl h-14'>Submit Placement Details</button>
      </div>
    </div>
  )
}
